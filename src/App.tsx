        ...
        <div className="flex-1 min-h-0 flex flex-col">
          ...
          <div className="flex-1 p-4 pt-0 overflow-y-auto">
            <div className="space-y-3">
              <div className={cn('rounded-xl p-3', darkMode ? 'bg-[#2d2d2d] border border-[#3c3c3c]' : 'art-card')}>
                <p className={cn('text-[10px] font-bold uppercase tracking-wider mb-1', darkMode ? 'text-[#e0e0e0]' : '')}>欢迎进入 LinkRag</p>
                <p className={cn('mono-label', darkMode && 'text-[#858585]')}>前后端联调版工作台</p>
              </div>
              <div className={cn('rounded-xl p-3', darkMode ? 'bg-[#2d2d2d] border border-[#3c3c3c]' : 'art-card')}>
                <p className={cn('text-[10px] font-bold uppercase tracking-wider mb-1', darkMode ? 'text-[#e0e0e0]' : '')}>知识库、文件、对话</p>
                <p className={cn('mono-label', darkMode && 'text-[#858585]')}>已接入当前可用后端接口</p>
              </div>
              <div className={cn('rounded-xl p-3', darkMode ? 'bg-[#2d2d2d] border border-[#3c3c3c]' : 'art-card')}>
                <p className={cn('text-[10px] font-bold uppercase tracking-wider mb-1', darkMode ? 'text-[#e0e0e0]' : '')}>欢迎页已启用</p>
                <p className={cn('mono-label', darkMode && 'text-[#858585]')}>退出登录会自动返回入口页</p>
              </div>
            </div>
          </div>
        </div>
