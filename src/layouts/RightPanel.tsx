...
export function RightPanel({ collapsed, onToggle, className }: RightPanelProps) {
      ...
      {collapsed ? (
        ...
        <>
          <div className="flex-1 min-h-0 flex flex-col">
            <div
              className={cn(
                'p-6 pb-2 flex justify-between items-center shrink-0',
                darkMode ? 'bg-[#252526]' : 'bg-white/20',
              )}
            >
            ...
            <div className="flex-1 p-4 pt-0 overflow-y-auto">
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={item.title}
                    className={cn('rounded-xl p-3', darkMode ? 'bg-[#2d2d2d] border border-[#3c3c3c]' : 'art-card')}
                  >
                    <p
                      className={cn(
          ...
          <div
            className={cn(
              'h-[30%] flex flex-col shrink-0',
              darkMode ? 'bg-[#252526] border-[#3c3c3c]' : 'bg-bg-base/20 border-border-subtle',
            )}
          >
            <div
              className={cn(
                'p-4 shrink-0',
                darkMode ? 'bg-[#252526] border-[#3c3c3c]' : 'bg-white/10 border-border-subtle',
              )}
            >
