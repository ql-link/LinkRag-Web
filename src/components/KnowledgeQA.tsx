    ...
    <div className="flex flex-col h-full bg-white rounded-3xl overflow-hidden shadow-sm">
      ...
      <div className="px-12 py-8 border-t border-border-subtle bg-bg-base/50">
        <div className="relative group">
          ...
          />
          <button className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-text-main text-white flex items-center justify-center hover:bg-primary transition-colors rounded-xl">
            <Send size={18} />
          </button>
        </div>
